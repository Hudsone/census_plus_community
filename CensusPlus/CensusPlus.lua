...
function CensusPlus_GetFactionRaces(faction)
	...
	if (faction == CENSUSPlus_HORDE) then
		ret = {CENSUSPLUS_ORC, CENSUSPLUS_TAUREN, CENSUSPLUS_TROLL, CENSUSPLUS_UNDEAD,
				...
				CENSUSPLUS_HIGHMOUNTAIN, CENSUSPLUS_NIGHTBORNE,
				CENSUSPLUS_MAGHAR,
	...
	elseif (faction == CENSUSPlus_ALLIANCE) then
		ret = {CENSUSPLUS_DWARF, CENSUSPLUS_GNOME, CENSUSPLUS_HUMAN, CENSUSPLUS_NIGHTELF,
				...
				CENSUSPLUS_LIGHTFORGED, CENSUSPLUS_VOIDELF,
				CENSUSPLUS_DARKIRON,
				CENSUSPLUS_KULTIRAN,
...
--		ret = {CENSUSPLUS_WARRIOR, CENSUSPLUS_HUNTER, CENSUSPLUS_PALADIN, CENSUSPLUS_ROGUE, CENSUSPLUS_PRIEST, CENSUSPLUS_MAGE, CENSUSPLUS_WARLOCK, CENSUSPLUS_DEATHKNIGHT, CENSUSPLUS_MONK};
	...
	elseif (race == CENSUSPLUS_APANDAREN) then
		ret = {CENSUSPLUS_WARRIOR, CENSUSPLUS_HUNTER, CENSUSPLUS_PRIEST, CENSUSPLUS_ROGUE, CENSUSPLUS_MAGE, CENSUSPLUS_MONK, CENSUSPLUS_DEATHKNIGHT};
	elseif (race == CENSUSPLUS_HPANDAREN) then
		ret = {CENSUSPLUS_WARRIOR, CENSUSPLUS_HUNTER, CENSUSPLUS_PRIEST, CENSUSPLUS_ROGUE, CENSUSPLUS_MAGE, CENSUSPLUS_MONK, CENSUSPLUS_SHAMAN, CENSUSPLUS_DEATHKNIGHT};
	elseif (race ==	CENSUSPLUS_HIGHMOUNTAIN) then
		ret = {CENSUSPLUS_DRUID, CENSUSPLUS_HUNTER, CENSUSPLUS_MONK, CENSUSPLUS_SHAMAN, CENSUSPLUS_WARRIOR, CENSUSPLUS_DEATHKNIGHT};
	elseif (race == CENSUSPLUS_NIGHTBORNE) then
		ret = {CENSUSPLUS_WARRIOR, CENSUSPLUS_HUNTER, CENSUSPLUS_PRIEST, CENSUSPLUS_ROGUE, CENSUSPLUS_MAGE, CENSUSPLUS_WARLOCK, CENSUSPLUS_MONK, CENSUSPLUS_DEATHKNIGHT};
	elseif (race == CENSUSPLUS_MAGHAR) then
		ret = {CENSUSPLUS_WARRIOR, CENSUSPLUS_HUNTER, CENSUSPLUS_PRIEST, CENSUSPLUS_ROGUE, CENSUSPLUS_MAGE, CENSUSPLUS_SHAMAN, CENSUSPLUS_MONK, CENSUSPLUS_DEATHKNIGHT};
	elseif (race == CENSUSPLUS_ZANDALARI) then 
		ret = {CENSUSPLUS_WARRIOR, CENSUSPLUS_HUNTER, CENSUSPLUS_ROGUE, CENSUSPLUS_MAGE, CENSUSPLUS_PRIEST, CENSUSPLUS_SHAMAN, CENSUSPLUS_WARLOCK, CENSUSPLUS_DRUID, CENSUSPLUS_PALADIN, CENSUSPLUS_DEATHKNIGHT};
	elseif (race == CENSUSPLUS_LIGHTFORGED) then
		ret = {CENSUSPLUS_MAGE, CENSUSPLUS_HUNTER, CENSUSPLUS_PALADIN, CENSUSPLUS_PRIEST, CENSUSPLUS_WARRIOR, CENSUSPLUS_DEATHKNIGHT};
	elseif (race == CENSUSPLUS_VOIDELF) then
		ret = {CENSUSPLUS_WARRIOR, CENSUSPLUS_HUNTER, CENSUSPLUS_PRIEST, CENSUSPLUS_ROGUE, CENSUSPLUS_MAGE, CENSUSPLUS_WARLOCK, CENSUSPLUS_MONK, CENSUSPLUS_DEATHKNIGHT};
	elseif (race == CENSUSPLUS_DARKIRON) then
		ret = {CENSUSPLUS_WARRIOR, CENSUSPLUS_PALADIN, CENSUSPLUS_HUNTER, CENSUSPLUS_ROGUE, CENSUSPLUS_MAGE, CENSUSPLUS_PRIEST, CENSUSPLUS_SHAMAN, CENSUSPLUS_WARLOCK, CENSUSPLUS_MONK, CENSUSPLUS_DEATHKNIGHT};
	elseif (race == CENSUSPLUS_KULTIRAN) then
		ret = {CENSUSPLUS_WARRIOR, CENSUSPLUS_HUNTER, CENSUSPLUS_ROGUE, CENSUSPLUS_MAGE, CENSUSPLUS_MONK, CENSUSPLUS_PRIEST, CENSUSPLUS_SHAMAN, CENSUSPLUS_DRUID, CENSUSPLUS_DEATHKNIGHT};
	elseif (race == CENSUSPLUS_VULPERA) then
		ret = {CENSUSPLUS_WARRIOR, CENSUSPLUS_HUNTER, CENSUSPLUS_ROGUE, CENSUSPLUS_MAGE, CENSUSPLUS_MONK, CENSUSPLUS_PRIEST, CENSUSPLUS_SHAMAN, CENSUSPLUS_WARLOCK, CENSUSPLUS_DEATHKNIGHT};
	elseif (race == CENSUSPLUS_MECHAGNOME) then
		ret = {CENSUSPLUS_WARRIOR, CENSUSPLUS_HUNTER, CENSUSPLUS_ROGUE, CENSUSPLUS_MAGE, CENSUSPLUS_MONK, CENSUSPLUS_PRIEST, CENSUSPLUS_WARLOCK, CENSUSPLUS_DEATHKNIGHT};
	end
	return ret;
end
